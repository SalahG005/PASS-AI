...
export interface CreateSkeletonProjectRequest {
  projectName: string;
...
export class WorkspaceApi {
  ...
  createSkeletonProject(body: CreateSkeletonProjectRequest): Observable<ProjectOpenResult> {
    return this.http.post<ProjectOpenResult>('/api/projects/skeleton', body);
  }
